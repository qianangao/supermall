<template>
 <tab-bar>
    ...
    <tab-bar-item path="/shoppingcar" activeColor="blue">
      <img slot="item-icon" src="~assets/img/tabbar/shoppingcar.png" alt="">
      <img slot="item-icon-active" src="~assets/img/tabbar/shoppingcar_active.png" alt="">
